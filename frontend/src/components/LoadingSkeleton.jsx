export function ProductCardSkeleton() {
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-4 backdrop-blur-xl animate-pulse space-y-3">
      ...
      <div className="h-10 w-full rounded-xl bg-slate-800/40" />
    </div>
  );
}
...
export function ProductPageSkeleton() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 animate-pulse">
      <div className="h-4 w-28 rounded bg-slate-800 mb-6" />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="aspect-square rounded-3xl border border-white/10 bg-slate-900/60 p-8" />
